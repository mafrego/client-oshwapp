  ...
  <div>
    <panel title="Create atom">
      ...
      <v-text-field
        ...
        id="id"
      ></v-text-field>
      <v-text-field label="link" :rules="[rules.required, rules.http]" v-model="atom.link" id="id"></v-text-field>
      <v-text-field
        label="weight"
      ...
      <v-text-field label="weight unit" :rules="[rules.required]" v-model="atom.weightUnit" id="id"></v-text-field>
    </panel>
    ...
    return {
      ...
      rules: {
        ...
        positiveInt: (value) => {
          ...
          return pattern.test(value) || "only positive integers > 0";
        }
      }
    }
  },
